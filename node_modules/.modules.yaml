...
hoistedDependencies:
  ...
  pkg-types@1.3.1:
    pkg-types: private
  postcss-load-config@6.0.1(postcss@8.5.24)(yaml@2.9.0):
  ...
  tsup@8.5.1(postcss@8.5.24)(typescript@5.9.3)(yaml@2.9.0):
    tsup: private
  type-check@0.4.0:
    type-check: private
  type-detect@4.1.0:
...
pendingBuilds: []
prunedAt: Tue, 28 Jul 2026 15:20:11 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
